package com.atguigu.crowd.pay.controller;
...
public class PayController {
    ...
    public String returnUrlMethod(HttpServletRequest request, HttpSession session) throws AlipayApiException, UnsupportedEncodingException {
        ...
        if (signVerified) {
            ...
            // 3.发送给MySQL的远程接口
            AppResult<String> resultEntity = mysqlRemoteService.saveOrderRemote(orderVO);
            log.info("Order save result= {}", resultEntity.getMessage());
